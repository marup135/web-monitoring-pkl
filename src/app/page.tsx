...
function DashboardContent() {
  ...
  const bgStyle: React.CSSProperties = boardBg ? {
  ...
  return (
    <>
      {GlobalBackground}
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-3 md:pt-4 pb-28 md:pb-8 flex-1 w-full text-[#0F172A] dark:text-gray-200">
        <AttendanceReminder onGoToAttendance={() => { setActiveTab('attendance'); setIsSettingsActive(false); }} />
        {/* Mobile Sticky Navbar */}
        <div className="sticky top-0 z-40 bg-white/85 dark:bg-[#1E293B]/85 backdrop-blur-xl border-b border-slate-200/80 dark:border-gray-700/80 flex md:hidden items-center justify-between px-4 h-14 -mx-4 sm:-mx-6 mb-4 print:hidden shadow-sm">
          <button
            ...
            <div className="relative w-72 bg-white dark:bg-[#243447] h-full shadow-2xl flex flex-col p-6 animate-in slide-in-from-left duration-300">
              ...
              <div className="flex flex-col gap-2 flex-1 mt-4">
                <button
                  ...
                  className={`flex items-center gap-3 px-4 py-3.5 rounded-2xl text-sm font-bold transition duration-200 w-full text-left cursor-pointer min-h-[52px] ${!isSettingsActive && activeTab === 'stats' ? 'bg-primary/10 dark:bg-primary/100/10 text-blue-600 dark:text-blue-400' : 'text-slate-500 dark:text-gray-400 hover:bg-slate-50 dark:hover:bg-gray-800'
                    }`}
                >
                  <BarChart3 size={20} />
                  {t('dashboard')}
                ...
                <button
                  ...
                  className={`flex items-center gap-3 px-4 py-3.5 rounded-2xl text-sm font-bold transition duration-200 w-full text-left cursor-pointer min-h-[52px] ${!isSettingsActive && activeTab === 'board' ? 'bg-primary/10 dark:bg-primary/100/10 text-blue-600 dark:text-blue-400' : 'text-slate-500 dark:text-gray-400 hover:bg-slate-50 dark:hover:bg-gray-800'
                    }`}
                >
                ...
                <button
                  ...
                  className={`flex items-center gap-3 px-4 py-3.5 rounded-2xl text-sm font-bold transition duration-200 w-full text-left cursor-pointer min-h-[52px] ${!isSettingsActive && activeTab === 'logbook' ? 'bg-primary/10 dark:bg-primary/100/10 text-blue-600 dark:text-blue-400' : 'text-slate-500 dark:text-gray-400 hover:bg-slate-50 dark:hover:bg-gray-800'
                    }`}
                >
                ...
                <button
                  ...
                  className={`flex items-center gap-3 px-4 py-3.5 rounded-2xl text-sm font-bold transition duration-200 w-full text-left cursor-pointer min-h-[52px] ${!isSettingsActive && activeTab === 'attendance' ? 'bg-primary/10 dark:bg-primary/100/10 text-blue-600 dark:text-blue-400' : 'text-slate-500 dark:text-gray-400 hover:bg-slate-50 dark:hover:bg-gray-800'
                    }`}
                >
                  <Clock size={20} />
                  {t('attendance')}
                ...
                <button
                  ...
                  className={`flex items-center gap-3 px-4 py-3.5 rounded-2xl text-sm font-bold transition duration-200 w-full text-left cursor-pointer min-h-[52px] ${isSettingsActive ? 'bg-primary/10 dark:bg-primary/100/10 text-blue-600 dark:text-blue-400' : 'text-slate-500 dark:text-gray-400 hover:bg-slate-50 dark:hover:bg-gray-800'
                    }`}
                >
                  <Settings size={20} />
                  {t('settings')}
        ...
        <div className="fixed bottom-0 left-0 right-0 z-40 bg-white/90 dark:bg-gray-900/95 backdrop-blur-xl border-t border-slate-200/80 dark:border-gray-700/80 flex md:hidden items-center justify-around h-16 pb-safe shadow-[0_-2px_10px_rgba(0,0,0,0.06)] print:hidden">
          <button
            onClick={() => { setActiveTab('stats'); setIsSettingsActive(false); }}
            className={`flex flex-col items-center justify-center flex-1 h-full cursor-pointer transition-colors ${!isSettingsActive && activeTab === 'stats' ? 'text-primary' : 'text-slate-400'
              }`}
          >
            <BarChart3 size={20} />
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center flex-1 h-full cursor-pointer transition-colors ${!isSettingsActive && activeTab === 'board' ? 'text-primary' : 'text-slate-400'
              }`}
          >
            <LayoutDashboard size={20} />
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center flex-1 h-full cursor-pointer transition-colors ${!isSettingsActive && activeTab === 'attendance' ? 'text-primary' : 'text-slate-400'
              }`}
          >
            <Clock size={20} />
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center flex-1 h-full cursor-pointer transition-colors ${!isSettingsActive && activeTab === 'logbook' ? 'text-primary' : 'text-slate-400'
              }`}
          >
            <FileSpreadsheet size={20} />
          ...
          {currentUser?.role !== 'siswa' && (
            <button
              onClick={() => setIsUserMenuOpen(true)}
              className={`flex flex-col items-center justify-center flex-1 h-full cursor-pointer transition-colors ${isUserMenuOpen && !isSettingsActive ? 'text-primary' : 'text-slate-400'
                }`}
            >
              <User size={20} />
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center flex-1 h-full cursor-pointer transition-colors ${isSettingsActive ? 'text-primary' : 'text-slate-400'
              }`}
          >
            <Settings size={20} />
        ...
        {/* Unified Desktop Header (Logo, Profile, Tabs) */}
        <div className="hidden md:flex flex-col gap-3 bg-white/[0.45] dark:bg-[#1E293B]/[0.45] backdrop-blur-md rounded-2xl p-3 shadow-sm mb-3 print:hidden relative z-40">
          {/* Top Header / Navigation Info */}
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-3 relative z-50">
            <div>
              <div className="flex items-center gap-2.5">
                <img
                  src="/nebo.png"
                  alt="NEBO Logo"
                  className="w-7 h-7 object-contain rounded-lg shadow-xs border border-[#E2E8F0] dark:border-gray-700"
                />
                <div>
                  <div className="flex items-center gap-2">
                  ...
                  <p className="text-[11px] text-[#64748B] dark:text-gray-400 font-medium">
            ...
            <div className="flex flex-wrap items-center gap-3 bg-white/50 dark:bg-[#1E293B]/50 backdrop-blur-md border border-[#E2E8F0]/30 dark:border-gray-700/30 rounded-xl p-2 px-3 shadow-sm">
              {isPembimbing && (
                <button
          ...
          {(!isPembimbing || viewMode !== 'detail' || showDetailTabs) && (
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-xl border text-xs font-semibold whitespace-nowrap transition-all duration-200 cursor-pointer ${!isSettingsActive && activeTab === 'board'
                  ...
                  : 'bg-white dark:bg-gray-800 border-slate-200 dark:border-gray-700 text-slate-600 dark:text-gray-300 hover:bg-slate-50 dark:hover:bg-gray-700 hover:text-primary dark:hover:text-primary shadow-sm'
                }`}
            >
            ...
            <button
              onClick={() => { setActiveTab('logbook'); setIsSettingsActive(false); }}
              className={`flex items-center gap-2 px-4 py-2 rounded-xl border text-xs font-semibold whitespace-nowrap transition-all duration-200 cursor-pointer ${!isSettingsActive && activeTab === 'logbook'
                  ? 'bg-primary border-primary text-white shadow-md shadow-primary/20'
                  : 'bg-white dark:bg-gray-800 border-slate-200 dark:border-gray-700 text-slate-600 dark:text-gray-300 hover:bg-slate-50 dark:hover:bg-gray-700 hover:text-primary dark:hover:text-primary shadow-sm'
                }`}
            >
            ...
            <button
              onClick={() => { setActiveTab('stats'); setIsSettingsActive(false); }}
              className={`flex items-center gap-2 px-4 py-2 rounded-xl border text-xs font-semibold whitespace-nowrap transition-all duration-200 cursor-pointer ${!isSettingsActive && activeTab === 'stats'
                  ? 'bg-primary border-primary text-white shadow-md shadow-primary/20'
                  : 'bg-white dark:bg-gray-800 border-slate-200 dark:border-gray-700 text-slate-600 dark:text-gray-300 hover:bg-slate-50 dark:hover:bg-gray-700 hover:text-primary dark:hover:text-primary shadow-sm'
                }`}
            >
            ...
            <button
              onClick={() => { setActiveTab('attendance'); setIsSettingsActive(false); }}
              className={`flex items-center gap-2 px-4 py-2 rounded-xl border text-xs font-semibold whitespace-nowrap transition-all duration-200 cursor-pointer ${!isSettingsActive && activeTab === 'attendance'
                  ? 'bg-primary border-primary text-white shadow-md shadow-primary/20'
                  : 'bg-white dark:bg-gray-800 border-slate-200 dark:border-gray-700 text-slate-600 dark:text-gray-300 hover:bg-slate-50 dark:hover:bg-gray-700 hover:text-primary dark:hover:text-primary shadow-sm'
                }`}
            >
            ...
            <button
              onClick={() => setIsSettingsActive(true)}
              className={`flex items-center gap-2 px-4 py-2 rounded-xl border text-xs font-semibold whitespace-nowrap transition-all duration-200 cursor-pointer ml-auto ${isSettingsActive
                  ? 'bg-primary border-primary text-white shadow-md shadow-primary/20'
                  : 'bg-white dark:bg-gray-800 border-slate-200 dark:border-gray-700 text-slate-600 dark:text-gray-300 hover:bg-slate-50 dark:hover:bg-gray-700 hover:text-primary dark:hover:text-primary shadow-sm'
                }`}
            >
...
export default function Home() {
  return (
    <PKLProvider>
      <div className="min-h-screen flex flex-col font-sans text-[#0F172A] dark:text-gray-200">
        <HomeWrapper />
      </div>
    </PKLProvider>
  );
