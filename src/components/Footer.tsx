        ...
        <div>
          ...
          <ul className="flex flex-col gap-3 text-sm text-slate-600 dark:text-gray-400">
            <li className="flex items-center gap-2">
              ...
              <a href="mailto:support@nebotrack.com" className="hover:text-blue-600 transition-colors">support@nebotrack.com</a>
            </li>
            <li className="flex items-center gap-2">
              <svg className="w-4 h-4 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li className="flex items-start gap-2 mt-2">
              ...
              <span className="leading-tight">Gedung Inovasi, Lt. 3<br/>Jl. Pendidikan No. 123, Jakarta</span>
            </li>
          </ul>
        </div>
      </div>
