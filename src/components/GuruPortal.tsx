    ...
    <div className="flex flex-col gap-6 text-[#0F172A]">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white border border-[#E2E8F0] rounded-2xl p-4 shadow-sm">
        <div>
          ...
          <p className="text-[11px] text-[#64748B]">Tinjau dan verifikasi logbook harian siswa di bawah bimbingan Anda.</p>
        </div>

        {currentUser?.classes && currentUser.classes.length > 1 && (
          <div className="flex items-center gap-2">
            <span className="text-xs font-semibold text-[#64748B]">Pilih Kelas:</span>
            <select
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div className="bg-white border border-[#E2E8F0] rounded-2xl p-4 shadow-sm flex items-center gap-3">
          ...
          <div>
            <span className="text-[10px] text-[#64748B] font-semibold block uppercase">Total Siswa</span>
        ...
        <div className="bg-white border border-[#E2E8F0] rounded-2xl p-4 shadow-sm flex items-center gap-3">
          ...
          <div>
            <span className="text-[10px] text-[#64748B] font-semibold block uppercase">Belum Direview</span>
        ...
        <div className="bg-white border border-[#E2E8F0] rounded-2xl p-4 shadow-sm flex items-center gap-3">
          ...
          <div>
            <span className="text-[10px] text-[#64748B] font-semibold block uppercase">Rerata Nilai (Internal)</span>
